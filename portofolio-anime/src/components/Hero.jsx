...
export default function Hero() {
    ...
    return (
        <section className="min-h-screen flex items-center px-6 md:px-20 relative overflow-hidden pt-10">
            ...
            <motion.div
                ...
                className="absolute right-[5%] md:right-[15%] top-0 bottom-0 w-24 md:w-40 bg-anime-red skew-x-[-20deg] origin-top pointer-events-none z-0"
            ></motion.div>
            ...
            <div className="z-10 max-w-5xl relative w-full mt-10">
                ...
                >
                    ...
                    <p className="text-lg font-medium leading-relaxed bg-white/90 dark:bg-zinc-900/90 text-gray-800 dark:text-gray-200 backdrop-blur-sm p-5 shadow-lg relative overflow-hidden group">
                        ...
                        Mahasiswa Teknik Informatika semester 8 di ITERA. Berfokus pada pengembangan antarmuka web modern dengan React dan membangun sistem backend yang tangguh.
                    </p>
                </motion.div>
